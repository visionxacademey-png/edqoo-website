...
export const courses: Course[] = [
  ...
  },
  {
    ...
    title: 'Mobile App Development (React Native & Swift)',
    category: 'App Development',
    description: 'Learn to design and build premium native iOS and Android applications from single codebase solutions.',
    ...
    status: 'coming-soon',
    featured: false,
    skills: ['React Native', 'Swift', 'Kotlin', 'Mobile UI', 'App Store Deploy']
  }
];
